      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-4 lg:px-8 md:py-16 flex flex-col lg:flex-row items-center gap-12 relative z-10">
        <div className="flex-1 flex flex-col justify-top">
          ...
          <p className="text-gray-700 text-justify [word-spacing:-1.5px] font-light mb-2 leading-relaxed text-lg">
            Ermetes ci tiene davvero all’ambiente. Grazie a un apposito sistema informatico interno può tenere traccia sia a preventivo che a consuntivo dell’impatto ambientale delle commesse, può utilizzare solo materiali sostenibili certificati ove richiesto e gestire la tracciabilità di filiera.
          </p>
