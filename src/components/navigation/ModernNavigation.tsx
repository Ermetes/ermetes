...
const ModernNavigation = () => {
  ...
  return (
    <nav
      className={`relative fixed top-0 left-0 right-0 z-50 transition-all duration-300 dm-sans-light bg-white/95 backdrop-blur-md shadow-sm border-b border-border/10`}
    >
